...
<html lang="en">
  ...
  <head>
    ...
    <title>Your Server - Xash3d Professional Servers</title>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><div class="main-blue-button"><a href="#discord">Discord</a></div></li>
            </ul>
              ...
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-4 col-sm-4">
                    <div class="info-stat">
                      <h6>Server Status:</h6>
                      <h4><?php if($server_online) echo "Online"; else echo "Offline"; ?></h4>
                    </div>
                  </div>
                  <div class="col-lg-4 col-sm-4">
                    <div class="info-stat">
                      <h6>Online Players:</h6>
                      <h4><?php if($server_online) { echo $servercon["activeplayers"] . "/" . $servercon["maxplayers"]; } else { echo "Unknown"; } ?></h4>
                    </div>
                  </div>
                  <div class="col-lg-4 col-sm-4">
                    <div class="info-stat">
                      <h6>Current Map:</h6>
                      <h4><?php if($server_online) { echo $servercon["map"]; } else { echo "Unknown"; } ?></h4>
                    </div>
                  </div>
                  <div class="col-lg-12">
                    <h2>Your Server Zombie Escape</h2>
                  </div>
                  <div class="col-lg-12">
            ...
            <div class="row">
              <div class="col-lg-3">
                <div class="features-item first-feature wow fadeInUp" data-wow-duration="1s" data-wow-delay="0s">
                  ...
                  <p>Come and play our server with other players.</p>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="features-item second-feature wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                  ...
                  <h4>Buy Admin</h4>
                  <div class="line-dec"></div>
                  <p>Buy admin and manage the server. (like: ban hackerz, kick users, mute swearers)</p>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="features-item first-feature wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                  ...
                  <h4>VIP Features</h4>
                  <div class="line-dec"></div>
                  <p>Buy a VIP permission and get some special features.</p>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="features-item second-feature last-features-item wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                  ...
                  <div class="icon"></div>
                  <h4>Buy Moderator</h4>
                  <div class="line-dec">Buy moderator and manage users. (like: kick users, mute swearers)</div>
                  <p></p>
                </div>
              </div>
            </div>
...
<!--
  ...
  <div id="discord" class="discord section">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
            <div class="iframe">
                <iframe src="https://discord.com/widget?id=812096967714930710&theme=dark" width="350" height="500" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
            </div>
